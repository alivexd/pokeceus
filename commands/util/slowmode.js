module.exports = {
  ...
  run: (client, message, args) => {
    ...
    if (message.member.hasPermission("MANAGE_CHANNEL"))
      if (isNaN(amount))
        return message.channel.send(" <:747689281065189376:821734873344901140> It doesn't seem to be valid number");
    if (args[0] === amount + "s") {
    ...
    if (args[0] === amount + "h") {
      ...
      message.channel.send(
        "<:747689281065189376:821734873344901140> You can only set seconds(s), minutes(min) and hours(h)"
      );
    }
  }
};